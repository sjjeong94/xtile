...
func.func @bad_rank_mismatch(%arg0: memref<2048xf32>) {
  ...
  %0 = xt.load(%arg0, %zero, %zero) : memref<2048xf32> -> tensor<16xf32>
  func.return
}
...
func.func @bad_element_type(%arg0: memref<2048x16xf32>) {
  %zero = arith.constant 0 : i32
  %0 = xt.load(%arg0, %zero, %zero) : memref<2048x16xf32> -> tensor<16x16xi32>
  func.return
}
...
func.func @bad_shared_hint(%arg0: memref<256x512xi8>) {
  %zero = arith.constant 0 : i32
  %0 = xt.load(%arg0, %zero, %zero) {shared = 2} : memref<256x512xi8> -> tensor<256x64xi8>
  func.return
}
