...
func.func @load_sets_thread_slices(%src: memref<128x128xf32>) {
  %0 = nova.load(%src) {start = array<i64: 0, 0>} : memref<128x128xf32> -> tensor<64x128xf32>
  nova.free(%0) : tensor<64x128xf32>
  func.return
}

// CHECK-LABEL: func.func @load_sets_threading
// CHECK: %[[LOAD:.*]] = nova.load(%arg0) {start = array<i64: 0, 0>} : memref<10x8xf32> -> tensor<5x8xf32, {shape0 = [3, 8], shape1 = [2, 8], start0 = [0, 0], start1 = [3, 0]}>
// CHECK: nova.free(%[[LOAD]]) : tensor<5x8xf32, {shape0 = [3, 8], shape1 = [2, 8], start0 = [0, 0], start1 = [3, 0]}>
// CHECK: return
// CHECK-LABEL: func.func @propagate_unary_and_casts
// CHECK: %[[LOAD2:.*]] = nova.load(%arg0) {start = array<i64: 0, 0>} : memref<10x8xf32> -> tensor<5x8xf32, {shape0 = [3, 8], shape1 = [2, 8], start0 = [0, 0], start1 = [3, 0]}>
...
// CHECK: %[[RSQRT:.*]] = nova.rsqrt(%[[SQUARE]]) : tensor<5x8xf32, {shape0 = [3, 8], shape1 = [2, 8], start0 = [0, 0], start1 = [3, 0]}> -> tensor<5x8xf32, {shape0 = [3, 8], shape1 = [2, 8], start0 = [0, 0], start1 = [3, 0]}>
...
// CHECK: nova.free(%[[FTOI]]) : tensor<5x8xi8, {shape0 = [3, 8], shape1 = [2, 8], start0 = [0, 0], start1 = [3, 0]}>
// CHECK: return
// CHECK-LABEL: func.func @propagate_scalar_ops
// CHECK: %[[LOADS:.*]] = nova.load(%arg0) {start = array<i64: 0, 0>} : memref<10x8xf32> -> tensor<5x8xf32, {shape0 = [3, 8], shape1 = [2, 8], start0 = [0, 0], start1 = [3, 0]}>
...
// CHECK: nova.free(%[[FMA]]) : tensor<5x8xf32, {shape0 = [3, 8], shape1 = [2, 8], start0 = [0, 0], start1 = [3, 0]}>
// CHECK: return
// CHECK-LABEL: func.func @propagate_reduce_and_binary
// CHECK: %[[LOADR:.*]] = nova.load(%arg0) {start = array<i64: 0, 0>} : memref<10x8xf32> -> tensor<5x8xf32, {shape0 = [3, 8], shape1 = [2, 8], start0 = [0, 0], start1 = [3, 0]}>
...
// CHECK: nova.free(%[[EW]]) : tensor<5x8xf32, {shape0 = [3, 8], shape1 = [2, 8], start0 = [0, 0], start1 = [3, 0]}>
// CHECK: return
// CHECK-LABEL: func.func @broadcast_propagates_max_threading
// CHECK: %[[LOADB0:.*]] = nova.load(%arg0) {start = array<i64: 0, 0>} : memref<10x8xf32> -> tensor<5x8xf32, {shape0 = [3, 8], shape1 = [2, 8], start0 = [0, 0], start1 = [3, 0]}>
// CHECK: %[[LOADB1:.*]] = nova.load(%arg0) {start = array<i64: 0, 0>} : memref<10x8xf32> -> tensor<3x8xf32, {shape0 = [2, 8], shape1 = [1, 8], start0 = [0, 0], start1 = [2, 0]}>
...
// CHECK: nova.free(%[[BMM]]) : tensor<5x8xf32, {shape0 = [3, 8], shape1 = [2, 8], start0 = [0, 0], start1 = [3, 0]}>
// CHECK: return
// CHECK-LABEL: func.func @matmul_propagates_lhs_and_strips_rhs
// CHECK: %[[LHS:.*]] = nova.load(%arg0) {start = array<i64: 0, 0>} : memref<10x4xf32> -> tensor<5x4xf32, {shape0 = [3, 4], shape1 = [2, 4], start0 = [0, 0], start1 = [3, 0]}>
// CHECK: %[[RHS:.*]] = nova.load(%arg1) {start = array<i64: 0, 0>} : memref<6x4xf32> -> tensor<3x4xf32, {shape0 = [3, 4], start0 = [0, 0]}>
// CHECK: %[[SCALE:.*]] = nova.load(%arg2) {start = array<i64: 0, 0>} : memref<3x4xf32> -> tensor<3x4xf32, {shape0 = [3, 4], start0 = [0, 0]}>
// CHECK: %[[BIAS:.*]] = nova.load(%arg3) {start = array<i64: 0, 0>} : memref<3x4xf32> -> tensor<3x4xf32, {shape0 = [3, 4], start0 = [0, 0]}>
...
// CHECK: nova.free(%[[MM]]) : tensor<5x4xf32, {shape0 = [3, 4], shape1 = [2, 4], start0 = [0, 0], start1 = [3, 0]}>
// CHECK: return
// CHECK-LABEL: func.func @overwrite_existing_threading
// CHECK: %[[LOAD3:.*]] = nova.load(%arg0) {start = array<i64: 0, 0>} : memref<12x8xf32> -> tensor<6x8xf32, {shape0 = [3, 8], shape1 = [3, 8], start0 = [0, 0], start1 = [3, 0]}>
// CHECK: nova.free(%[[LOAD3]]) : tensor<6x8xf32, {shape0 = [3, 8], shape1 = [3, 8], start0 = [0, 0], start1 = [3, 0]}>
// CHECK: return
// CHECK-LABEL: func.func @load_sets_thread_slices
// CHECK: %[[LOAD4:.*]] = nova.load(%arg0) {start = array<i64: 0, 0>} : memref<128x128xf32> -> tensor<64x128xf32, {shape0 = [32, 128], shape1 = [32, 128], start0 = [0, 0], start1 = [32, 0]}>
// CHECK: nova.free(%[[LOAD4]]) : tensor<64x128xf32, {shape0 = [32, 128], shape1 = [32, 128], start0 = [0, 0], start1 = [32, 0]}>
// CHECK: return
