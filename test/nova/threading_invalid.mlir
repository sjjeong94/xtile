...
func.func @broadcast_threading_one_sided(%src: memref<10x8xf32>, %rhs: tensor<3x8xf32>) {
  ...
  %1 = nova.broadcast 0 %0, %rhs lhs 1.000000e+00 0.000000e+00 rhs 1.000000e+00 0.000000e+00 : tensor<5x8xf32>, tensor<3x8xf32> -> tensor<5x8xf32>
  func.return
}
...
func.func @elementwise_threading_mismatch(%src: memref<10x8xf32>) {
  ...
  %2 = nova.elementwise 0 %0, %1 lhs 1.000000e+00 0.000000e+00 rhs 1.000000e+00 0.000000e+00 : tensor<5x8xf32>, tensor<3x8xf32> -> tensor<5x8xf32>
  func.return
}
