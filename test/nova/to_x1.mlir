...
func.func @rowwise_softmax(%arg0: memref<128x64xf32>,
  ...
  %1 = nova.reduce(%0) {axis = 1 : i64, mode = 1 : i32} : tensor<64x64xf32, {bank0 = 0 : i64, bank1 = 1 : i64, space = 3 : i64, threading = 32 : i64}> -> tensor<64x1xf32, {bank0 = 2 : i64, bank1 = 3 : i64, space = 3 : i64, threading = 32 : i64}>
  ...
  nova.barrier() {mode = 0 : i32}
  %4 = nova.reduce(%3) {axis = 1 : i64, mode = 0 : i32} : tensor<64x64xf32, {bank0 = 2 : i64, space = 3 : i64}> -> tensor<64x1xf32, {bank0 = 4 : i64, space = 3 : i64}>
  nova.barrier() {mode = 0 : i32}
  ...
  %8 = nova.reduce(%7) {axis = 1 : i64, mode = 1 : i32} : tensor<64x64xf32, {bank0 = 2 : i64, bank1 = 3 : i64, space = 3 : i64, threading = 32 : i64}> -> tensor<64x1xf32, {bank0 = 6 : i64, bank1 = 7 : i64, space = 3 : i64, threading = 32 : i64}>
  nova.barrier() {mode = 0 : i32}
  ...
  nova.barrier() {mode = 0 : i32}
  %11 = nova.reduce(%10) {axis = 1 : i64, mode = 0 : i32} : tensor<64x64xf32, {bank0 = 2 : i64, space = 3 : i64}> -> tensor<64x1xf32, {bank0 = 6 : i64, space = 3 : i64}>
  nova.barrier() {mode = 0 : i32}
...
// CHECK-NEXT: x1.barrier {mode = 0}
// CHECK-NEXT: x1.reduce {inp0 = 2, inp1 = 2, out0 = 4, out1 = 4, shape = [32, 64], axis = 1, mode = 0}
// CHECK-NEXT: x1.barrier {mode = 0}
...
// CHECK-NEXT: x1.barrier {mode = 0}
// CHECK-NEXT: x1.reduce {inp0 = 2, inp1 = 2, out0 = 6, out1 = 6, shape = [32, 64], axis = 1, mode = 0}
// CHECK-NEXT: x1.barrier {mode = 0}
...
func.func @rowwise_layernorm(%arg0: memref<128x64xf32>, %arg1: memref<1x64xf32>,
  ...
  %3 = nova.reduce(%0) {axis = 1 : i64, mode = 0 : i32} : tensor<64x64xf32, {bank0 = 0 : i64, bank1 = 1 : i64, space = 3 : i64, threading = 32 : i64}> -> tensor<64x1xf32, {bank0 = 6 : i64, bank1 = 7 : i64, space = 3 : i64, threading = 32 : i64}>
  nova.barrier() {mode = 0 : i32}
  ...
  nova.barrier() {mode = 0 : i32}
  %6 = nova.reduce(%5) {axis = 1 : i64, mode = 0 : i32} : tensor<64x64xf32, {bank0 = 6 : i64, bank1 = 7 : i64, space = 3 : i64, threading = 32 : i64}> -> tensor<64x1xf32, {bank0 = 10 : i64, bank1 = 11 : i64, space = 3 : i64, threading = 32 : i64}>
  nova.barrier() {mode = 0 : i32}
  ...
  %13 = nova.reduce(%12) {axis = 1 : i64, mode = 0 : i32} : tensor<64x64xf32, {bank0 = 8 : i64, bank1 = 9 : i64, space = 3 : i64, threading = 32 : i64}> -> tensor<64x1xf32, {bank0 = 10 : i64, bank1 = 11 : i64, space = 3 : i64, threading = 32 : i64}>
  nova.barrier() {mode = 0 : i32}
  ...
  nova.barrier() {mode = 0 : i32}
  %16 = nova.reduce(%15) {axis = 1 : i64, mode = 0 : i32} : tensor<64x64xf32, {bank0 = 8 : i64, bank1 = 9 : i64, space = 3 : i64, threading = 32 : i64}> -> tensor<64x1xf32, {bank0 = 10 : i64, bank1 = 11 : i64, space = 3 : i64, threading = 32 : i64}>
  nova.barrier() {mode = 0 : i32}
...
func.func @column_reduce(%arg0: memref<64x64xf32>) {
  %0 = nova.load(%arg0) {start = [0, 0]} : memref<64x64xf32> -> tensor<64x64xf32, {bank0 = 0 : i64, bank1 = 1 : i64, space = 3 : i64, threading = 32 : i64}>
  %1 = nova.reduce(%0) {axis = 0 : i64, mode = 0 : i32} : tensor<64x64xf32, {bank0 = 0 : i64, bank1 = 1 : i64, space = 3 : i64, threading = 32 : i64}> -> tensor<1x64xf32, {bank0 = 2 : i64, space = 3 : i64}>
  return
}
