...
func.func @insert_after_compute_and_before_return(%src: memref<16x16xf32>, %dst: memref<16x16xf32>) {
  %0 = nova.load %src [0, 0] : memref<16x16xf32> -> tensor<16x16xf32>
...
func.func @insert_after_store_when_double_buffering_disabled(%src: memref<16x16xf32>, %dst: memref<16x16xf32>) attributes {xt.double_buffering = 0 : i32} {
  %0 = nova.load %src [0, 0] : memref<16x16xf32> -> tensor<16x16xf32>
  nova.store %0, %dst [0, 0] : (tensor<16x16xf32>, memref<16x16xf32>) -> ()
  func.return
}
...
func.func @insert_keep_alive_when_double_buffering_enabled(%src: memref<16x16xf32>, %dst: memref<16x16xf32>) attributes {xt.double_buffering = 1 : i32} {
  ...
  nova.store %2, %dst [0, 0] : (tensor<16x16xf32>, memref<16x16xf32>) -> ()
  func.return
}

// CHECK-LABEL: func.func @insert_after_compute_and_before_return
// CHECK: %[[LOAD:.*]] = nova.load %arg0 [0, 0] : memref<16x16xf32> -> tensor<16x16xf32>
// CHECK: %[[SQUARE:.*]] = nova.square %[[LOAD]] : tensor<16x16xf32> -> tensor<16x16xf32>
// CHECK-NEXT: nova.barrier 0
// CHECK-NEXT: nova.store %[[SQUARE]], %arg1 [0, 0] : (tensor<16x16xf32>, memref<16x16xf32>) -> ()
// CHECK-NEXT: nova.barrier 1
// CHECK-NEXT: return

// CHECK-LABEL: func.func @skip_existing_barriers
// CHECK: %[[LOAD2:.*]] = nova.load %arg0 [0, 0] : memref<16x16xf32> -> tensor<16x16xf32>
// CHECK: %[[SQUARE2:.*]] = nova.square %[[LOAD2]] : tensor<16x16xf32> -> tensor<16x16xf32>
// CHECK-NEXT: nova.barrier 0
// CHECK-NEXT: nova.store %[[SQUARE2]], %arg1 [0, 0] : (tensor<16x16xf32>, memref<16x16xf32>) -> ()
// CHECK-NEXT: nova.barrier 1
// CHECK-NEXT: return

// CHECK-LABEL: func.func @insert_after_store_when_double_buffering_disabled
// CHECK: %[[LOAD3:.*]] = nova.load %arg0 [0, 0] : memref<16x16xf32> -> tensor<16x16xf32>
// CHECK-NEXT: nova.store %[[LOAD3]], %arg1 [0, 0] : (tensor<16x16xf32>, memref<16x16xf32>) -> ()
// CHECK-NEXT: nova.barrier 1
// CHECK-NEXT: return

// CHECK-LABEL: func.func @insert_after_store_when_double_buffering_unspecified
// CHECK: %[[LOAD4:.*]] = nova.load %arg0 [0, 0] : memref<16x16xf32> -> tensor<16x16xf32>
// CHECK-NEXT: nova.store %[[LOAD4]], %arg1 [0, 0] : (tensor<16x16xf32>, memref<16x16xf32>) -> ()
// CHECK-NEXT: nova.barrier 1
// CHECK-NEXT: return

// CHECK-LABEL: func.func @insert_keep_alive_when_double_buffering_enabled
// CHECK: %[[LOAD_DB:.*]] = nova.load %arg0 [0, 0] : memref<16x16xf32> -> tensor<16x16xf32>
...
// CHECK-NEXT: nova.barrier 0
// CHECK-NEXT: nova.store %[[EXP_DB]], %arg1 [0, 0] : (tensor<16x16xf32>, memref<16x16xf32>) -> ()
...
// IDEMPOTENT: %[[LOAD5:.*]] = nova.load %arg0 [0, 0] : memref<16x16xf32> -> tensor<16x16xf32>
// IDEMPOTENT: %[[SQUARE5:.*]] = nova.square %[[LOAD5]] : tensor<16x16xf32> -> tensor<16x16xf32>
// IDEMPOTENT-NEXT: nova.barrier 0
// IDEMPOTENT-NEXT: nova.store %[[SQUARE5]], %arg1 [0, 0] : (tensor<16x16xf32>, memref<16x16xf32>) -> ()
// IDEMPOTENT-NEXT: nova.barrier 1
// IDEMPOTENT-NEXT: return

// IDEMPOTENT-LABEL: func.func @skip_existing_barriers
// IDEMPOTENT: %[[LOAD6:.*]] = nova.load %arg0 [0, 0] : memref<16x16xf32> -> tensor<16x16xf32>
// IDEMPOTENT: %[[SQUARE6:.*]] = nova.square %[[LOAD6]] : tensor<16x16xf32> -> tensor<16x16xf32>
// IDEMPOTENT-NEXT: nova.barrier 0
// IDEMPOTENT-NEXT: nova.store %[[SQUARE6]], %arg1 [0, 0] : (tensor<16x16xf32>, memref<16x16xf32>) -> ()
// IDEMPOTENT-NEXT: nova.barrier 1
// IDEMPOTENT-NEXT: return

// IDEMPOTENT-LABEL: func.func @insert_after_store_when_double_buffering_disabled
// IDEMPOTENT: %[[LOAD7:.*]] = nova.load %arg0 [0, 0] : memref<16x16xf32> -> tensor<16x16xf32>
// IDEMPOTENT-NEXT: nova.store %[[LOAD7]], %arg1 [0, 0] : (tensor<16x16xf32>, memref<16x16xf32>) -> ()
// IDEMPOTENT-NEXT: nova.barrier 1
// IDEMPOTENT-NEXT: return

// IDEMPOTENT-LABEL: func.func @insert_after_store_when_double_buffering_unspecified
// IDEMPOTENT: %[[LOAD8:.*]] = nova.load %arg0 [0, 0] : memref<16x16xf32> -> tensor<16x16xf32>
// IDEMPOTENT-NEXT: nova.store %[[LOAD8]], %arg1 [0, 0] : (tensor<16x16xf32>, memref<16x16xf32>) -> ()
// IDEMPOTENT-NEXT: nova.barrier 1
// IDEMPOTENT-NEXT: return

// IDEMPOTENT-LABEL: func.func @insert_keep_alive_when_double_buffering_enabled
// IDEMPOTENT: %[[LOAD9:.*]] = nova.load %arg0 [0, 0] : memref<16x16xf32> -> tensor<16x16xf32>
...
// IDEMPOTENT-NEXT: nova.barrier 0
// IDEMPOTENT-NEXT: nova.store %[[EXP9]], %arg1 [0, 0] : (tensor<16x16xf32>, memref<16x16xf32>) -> ()
