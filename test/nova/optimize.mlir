...
module {
  func.func @fold_rhs_scalar_into_broadcast(%arg0: tensor<16x16xf32>, %arg1: tensor<16x1xf32>) -> tensor<16x16xf32> {
    ...
    %1 = nova.broadcast 1 %arg0, %0 {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, rhs_a = 4.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x16xf32>, tensor<16x1xf32> -> tensor<16x16xf32>
  ...
  func.func @fold_lhs_scalar_into_elementwise(%arg0: tensor<16x16xf32>, %arg1: tensor<16x16xf32>) -> tensor<16x16xf32> {
    ...
    %1 = nova.elementwise 1 %0, %arg1 {lhs_a = 8.000000e+00 : f32, lhs_b = 1.000000e+00 : f32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x16xf32>, tensor<16x16xf32> -> tensor<16x16xf32>
    return %1 : tensor<16x16xf32>
  }
  ...
  func.func @fold_both_sides(%arg0: tensor<16x16xf32>, %arg1: tensor<16x16xf32>) -> tensor<16x16xf32> {
    ...
    %2 = nova.elementwise 1 %0, %1 {lhs_a = 8.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, rhs_a = 1.000000e+00 : f32, rhs_b = 5.000000e-01 : f32} : tensor<16x16xf32>, tensor<16x16xf32> -> tensor<16x16xf32>
  ...
  func.func @fold_sub_scalar_as_add_with_negated_rhs(%arg0: tensor<16x16xf32>, %arg1: tensor<16x16xf32>) -> tensor<16x16xf32> {
    ...
    %1 = nova.elementwise 1 %arg0, %0 {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x16xf32>, tensor<16x16xf32> -> tensor<16x16xf32>
    return %1 : tensor<16x16xf32>
  }
  ...
  func.func @fold_broadcast_mul_into_matmul(%lhs: tensor<16x32xf32>, %rhs: tensor<32x8xf32>, %scale_arg: tensor<1x1xf32>) -> tensor<16x8xf32> {
    ...
    %0 = nova.matmul %lhs, %rhs, %scale, %bias : tensor<16x32xf32>, tensor<32x8xf32>, tensor<1x1xf32>, tensor<1x1xf32> -> tensor<16x8xf32>
    %1 = nova.broadcast 2 %0, %scale_arg {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x8xf32>, tensor<1x1xf32> -> tensor<16x8xf32>
    return %1 : tensor<16x8xf32>
  }
  ...
  func.func @fold_broadcast_add_into_matmul(%lhs: tensor<16x32xf32>, %rhs: tensor<32x8xf32>, %bias_arg: tensor<1x1xf32>) -> tensor<16x8xf32> {
    ...
    %bias = arith.constant dense<0.000000e+00> : tensor<1x1xf32>
    %0 = nova.matmul %lhs, %rhs, %scale, %bias : tensor<16x32xf32>, tensor<32x8xf32>, tensor<1x1xf32>, tensor<1x1xf32> -> tensor<16x8xf32>
    %1 = nova.broadcast 1 %0, %bias_arg {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x8xf32>, tensor<1x1xf32> -> tensor<16x8xf32>
    return %1 : tensor<16x8xf32>
  }
  ...
  func.func @do_not_fold_broadcast_mul_into_int_matmul(%lhs: tensor<16x32xi8>, %rhs: tensor<32x8xi8>, %scale_arg: tensor<1x1xf32>) -> tensor<16x8xi32> {
    ...
    %bias = arith.constant dense<0.000000e+00> : tensor<1x1xf32>
    %0 = nova.matmul %lhs, %rhs, %scale, %bias : tensor<16x32xi8>, tensor<32x8xi8>, tensor<1x1xf32>, tensor<1x1xf32> -> tensor<16x8xi32>
    %1 = nova.broadcast 2 %0, %scale_arg {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x8xi32>, tensor<1x1xf32> -> tensor<16x8xi32>
    return %1 : tensor<16x8xi32>
  }
  ...
  func.func @do_not_fold_broadcast_add_into_int_matmul(%lhs: tensor<16x32xi8>, %rhs: tensor<32x8xi8>, %bias_arg: tensor<1x1xf32>) -> tensor<16x8xi32> {
    ...
    %bias = arith.constant dense<0.000000e+00> : tensor<1x1xf32>
    %0 = nova.matmul %lhs, %rhs, %scale, %bias : tensor<16x32xi8>, tensor<32x8xi8>, tensor<1x1xf32>, tensor<1x1xf32> -> tensor<16x8xi32>
    %1 = nova.broadcast 1 %0, %bias_arg {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x8xi32>, tensor<1x1xf32> -> tensor<16x8xi32>
    return %1 : tensor<16x8xi32>
  }
...
// CHECK: nova.broadcast 1 %arg0, %arg1 {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, rhs_a = 4.000000e+00 : f32, rhs_b = 1.000000e+00 : f32} : tensor<16x16xf32>, tensor<16x1xf32> -> tensor<16x16xf32>

// CHECK-LABEL: func.func @fold_lhs_scalar_into_elementwise
// CHECK: nova.elementwise 1 %arg0, %arg1 {lhs_a = 4.000000e+00 : f32, lhs_b = 1.000000e+00 : f32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x16xf32>, tensor<16x16xf32> -> tensor<16x16xf32>

// CHECK-LABEL: func.func @fold_both_sides
// CHECK: nova.elementwise 1 %arg0, %arg1 {lhs_a = 8.000000e+00 : f32, lhs_b = 1.000000e+00 : f32, rhs_a = 2.000000e+00 : f32, rhs_b = 5.000000e-01 : f32} : tensor<16x16xf32>, tensor<16x16xf32> -> tensor<16x16xf32>

// CHECK-LABEL: func.func @fold_sub_scalar_as_add_with_negated_rhs
// CHECK: nova.elementwise 1 %arg0, %arg1 {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, rhs_a = 1.000000e+00 : f32, rhs_b = -7.500000e-01 : f32} : tensor<16x16xf32>, tensor<16x16xf32> -> tensor<16x16xf32>
...
// CHECK: %[[BCAST:.*]] = nova.broadcast 2 %[[MM]], %arg2 {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x8xf32>, tensor<1x1xf32> -> tensor<16x8xf32>
...
// CHECK: %[[BCAST2:.*]] = nova.broadcast 1 %[[MM2]], %arg2 {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x8xf32>, tensor<1x1xf32> -> tensor<16x8xf32>
...
// CHECK: nova.broadcast 2 %[[IMMMUL]], %arg2 {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x8xi32>, tensor<1x1xf32> -> tensor<16x8xi32>
...
// CHECK: nova.broadcast 1 %[[IMMADD]], %arg2 {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x8xi32>, tensor<1x1xf32> -> tensor<16x8xi32>
