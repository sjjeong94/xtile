...
module {
  ...
  func.func @do_not_fold_scalar_into_int_matmul(%lhs: tensor<16x32xi8>, %rhs: tensor<32x8xi8>) -> tensor<16x8xi32> {
    ...
    %1 = nova.scalar(%0) {mode = 1 : i32, rhs = 2.500000e-01 : f32} : tensor<16x8xi32> -> tensor<16x8xi32>
  ...
  func.func @do_not_fold_broadcast_mul_into_int_matmul(%lhs: tensor<16x32xi8>, %rhs: tensor<32x8xi8>, %scale_arg: tensor<1x1xf32>) -> tensor<16x8xi32> {
    ...
    %bias = arith.constant dense<0.000000e+00> : tensor<1x1xf32>
    %0 = nova.matmul(%lhs, %rhs, %scale, %bias) : tensor<16x32xi8>, tensor<32x8xi8>, tensor<1x1xf32>, tensor<1x1xf32> -> tensor<16x8xi32>
    %1 = nova.broadcast(%0, %scale_arg) {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, mode = 2 : i32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x8xi32>, tensor<1x1xf32> -> tensor<16x8xi32>
    return %1 : tensor<16x8xi32>
  }
  ...
  func.func @do_not_fold_broadcast_add_into_int_matmul(%lhs: tensor<16x32xi8>, %rhs: tensor<32x8xi8>, %bias_arg: tensor<1x1xf32>) -> tensor<16x8xi32> {
    ...
    %bias = arith.constant dense<0.000000e+00> : tensor<1x1xf32>
    %0 = nova.matmul(%lhs, %rhs, %scale, %bias) : tensor<16x32xi8>, tensor<32x8xi8>, tensor<1x1xf32>, tensor<1x1xf32> -> tensor<16x8xi32>
    %1 = nova.broadcast(%0, %bias_arg) {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, mode = 1 : i32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x8xi32>, tensor<1x1xf32> -> tensor<16x8xi32>
    return %1 : tensor<16x8xi32>
  }
...
// CHECK: nova.scalar(%[[IMM]]) {mode = 1 : i32, rhs = 2.500000e-01 : f32} : tensor<16x8xi32> -> tensor<16x8xi32>
...
// CHECK: nova.broadcast(%[[IMMMUL]], %arg2) {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, mode = 2 : i32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x8xi32>, tensor<1x1xf32> -> tensor<16x8xi32>
...
// CHECK: nova.broadcast(%[[IMMADD]], %arg2) {lhs_a = 1.000000e+00 : f32, lhs_b = 0.000000e+00 : f32, mode = 1 : i32, rhs_a = 1.000000e+00 : f32, rhs_b = 0.000000e+00 : f32} : tensor<16x8xi32>, tensor<1x1xf32> -> tensor<16x8xi32>
