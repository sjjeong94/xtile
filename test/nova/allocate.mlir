...
// CHECK: %[[LOAD0:.*]] = nova.load(%arg0) {start = array<i64: 0, 0>} : memref<64x16xf32> -> tensor<16x16xf32, {bank0 = 0 : i64, space = 3 : i64}>
// CHECK: %[[SQUARE0:.*]] = nova.square(%[[LOAD0]]) : tensor<16x16xf32, {bank0 = 0 : i64, space = 3 : i64}> -> tensor<16x16xf32, {bank0 = 1 : i64, space = 3 : i64}>
// CHECK: nova.store(%[[SQUARE0]], %arg1) {start = array<i64: 0, 0>} : (tensor<16x16xf32, {bank0 = 1 : i64, space = 3 : i64}>, memref<64x16xf32>) -> ()
// CHECK: %[[LOAD1:.*]] = nova.load(%arg0) {start = array<i64: 1, 0>} : memref<64x16xf32> -> tensor<16x16xf32, {bank0 = 0 : i64, space = 3 : i64}>
...
// CHECK: nova.store(%[[SQUARE1]], %arg1) {start = array<i64: 1, 0>} : (tensor<16x16xf32, {bank0 = 1 : i64, space = 3 : i64}>, memref<64x16xf32>) -> ()
// CHECK-NOT: nova.free(
...
// CHECK: nova.store(%[[SMALL]], %arg2) {start = array<i64: 0, 0>} : (tensor<16x16xf32, {bank0 = 3 : i64, space = 3 : i64}>, memref<16x16xf32>) -> ()
// CHECK-NOT: nova.free(
// CHECK-LABEL: func.func @allocate_space_assignment
// CHECK: %[[LHS:.*]] = nova.load(%arg0) {start = array<i64: 0, 0>} : memref<16x32xf32> -> tensor<16x32xf32, {bank0 = 0 : i64, space = 3 : i64}>
// CHECK: %[[RHS:.*]] = nova.load(%arg1) {start = array<i64: 0, 0>} : memref<32x8xf32> -> tensor<32x8xf32, {bank0 = 1 : i64, space = 3 : i64}>
// CHECK: %[[SCALE:.*]] = nova.load(%arg2) {start = array<i64: 0, 0>} : memref<16x8xf32> -> tensor<16x8xf32, {bank0 = 0 : i64, space = 4 : i64}>
// CHECK: %[[BIAS:.*]] = nova.load(%arg3) {start = array<i64: 0, 0>} : memref<16x8xf32> -> tensor<16x8xf32, {bank0 = 0 : i64, space = 5 : i64}>
...
// CHECK: %[[SPLIT:.*]] = nova.square(%arg0) : tensor<64x128xf32, {shape0 = [32, 128], shape1 = [32, 128], start0 = [0, 0], start1 = [32, 0], threading = 32 : i64}> -> tensor<64x128xf32, {bank0 = 0 : i64, bank1 = 1 : i64, shape0 = [32, 128], shape1 = [32, 128], space = 3 : i64, start0 = [0, 0], start1 = [32, 0], threading = 32 : i64}>
// CHECK-NOT: nova.free(
